...
class ScrollDataWeight extends StatefulWidget {
  const ScrollDataWeight({super.key});

  @override
  State<ScrollDataWeight> createState() => _ScrollDataWeightState();
}

class _ScrollDataWeightState extends State<ScrollDataWeight> {
  Future<void> _saveProfile() async {
    final user = Provider.of<UserProfileInit>(context, listen: false);
    user.weight = controller.selectedItem + startitem;
    dispose();
  }
    ...
    return SafeArea(
        child: Scaffold(
            appBar: AppBarsBuild(
              ...
              leading: IconButton(
                  onPressed: () {
                    Navigator.pushNamed(context, '/databornreg');
                  },
                  icon: const Icon(
              ...
              children: [
                ...
                ButtonNext(function: () {
                  userDataProvider.updateUserData(
                      'weight', controller.selectedItem + startitem);
